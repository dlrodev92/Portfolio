        ...
        >
          ...
          <div className='w-full bg-slate-200 flex flex-col justify-start md:justify-center items-center rounded-lg p-3'>
            ...
            <div className="flex w-full justify-around items-center">
                <a href="davidlopezportfolio.netlify.app" target="_blank"><img src={screenWidth > 1023 ? "https://i.ibb.co/5xt2MP2/Untitled-design-22.png" : "https://i.ibb.co/wwbJcLz/Untitled-design-21.png"} alt="migthywebsite" className="w-[200px] p-5 hover:scale-110  duration-500 cursor-pointer "/></a>
